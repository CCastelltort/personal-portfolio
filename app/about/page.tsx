    ...
    <div className="min-h-screen px-10 flex flex-col bg-gradient-to-r from-blue-700 to-purple-700">
      ...
      <div className="mt-8 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 pb-12">
        ...
        <div className="bg-white/30 p-6 rounded-2xl shadow-md text-white lg:col-span-3 text-justify mt-6 transition-transform duration-300 hover:scale-102 border border-white">
          <p>
            Hi! I’m Carlota Castelltort Pinto, a senior at Texas Christian University (TCU) pursuing a <span className="font-bold underline decoration-skip-ink">B.S. 
            in Computer Science</span> with minors in Mathematics and General Business. I’m passionate about <span className="font-bold underline">software 
            engineering</span> and <span className="font-bold underline"> web development</span>, and as I prepare to graduate in <span className="font-bold underline">Spring 
            2026</span>, I’m excited to keep growing as a developer and contribute to innovative and impactful projects. 
          </p>
          <br></br>
          ...
          <p>
            ...
            SWE (Society of Women Engineers), and the Robotics and AI Club</span>. I’ve also gained valuable experience working as 
            an <span className="font-bold underline">IT Assistant and Horned Frog Hospitality Ambassador</span>, roles that strengthened both my 
